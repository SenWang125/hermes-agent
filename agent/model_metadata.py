        ...
        if not _is_known_provider_base_url(base_url):
            ...
            if is_local_endpoint(base_url):
                ...
                if local_ctx and local_ctx > 0:
                    ...
                    return local_ctx
            # Don't short-circuit here — fall through to hardcoded defaults
            # and other resolution methods. LiteLLM gateways and similar
            # proxies often omit context_length from /models responses for
            # well-known models (Claude, GPT, etc.) that have reliable
            # hardcoded entries below.
            logger.debug(
                "Custom endpoint %s did not report context length for %r — "
